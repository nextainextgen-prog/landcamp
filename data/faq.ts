...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: {
      th: "ราคาเริ่มต้น 4,500 บาทต่อคืน (วันธรรมดา) ส่วนวันหยุดเริ่มต้น 5,500 บาท ราคารวมอาหารเช้าสำหรับผู้เข้าพักทุกท่าน เด็กอายุไม่เกิน 10 ปี พักฟรี ตั้งแต่ 11 ปีขึ้นไปคิดเพิ่ม 750 บาทต่อท่านต่อคืน โปรโมชั่นปรับเปลี่ยนตามแต่ละเดือน",
      en: "Rates start at THB 4,500 per night on weekdays and THB 5,500 on weekends. All stays include breakfast. Children aged 10 and under stay free; ages 11 and up are charged THB 750 per person per night. Monthly promotions may apply.",
    },
  },
  {
    id: "faq-family",
