...
export const siteConfig = {
  ...
  policy: {
    ...
    wifi: true,
    extraGuest: {
      // เด็กอายุไม่เกิน 10 ปี พักฟรี | ตั้งแต่ 11 ปีขึ้นไป คิดเพิ่ม 750 บาท/ท่าน/คืน
      freeAgeMax: 10,
      feePerNight: 750,
    },
    childPolicy: {
      th: "เด็กอายุไม่เกิน 10 ปี พักฟรี | ตั้งแต่ 11 ปีขึ้นไป คิดเพิ่ม 750 บาท/ท่าน/คืน",
      en: "Children 10 and under stay free | Ages 11+ charged 750 THB per person per night",
    },
    /**
     * เงื่อนไขการเข้าพัก — แสดงบนใบการจอง/ใบเสร็จ (แก้ที่นี่ที่เดียว = แหล่งความจริงเดียว)
     */
    houseRules: {
      th: [
        "เวลาเช็คอิน 14.00 น. / เช็คเอาท์ 12.00 น.",
        "ห้องพักมีบริการ Wi-Fi ฟรี",
        "ราคาห้องพักรวมอาหารเช้าสำหรับผู้เข้าพักทุกท่าน",
        "ไม่อนุญาตให้นำสัตว์เลี้ยงทุกชนิดเข้าพัก ฝ่าฝืนปรับ 2,000 บาท",
        "งดสูบบุหรี่ภายในห้องพักโดยเด็ดขาด",
        "ห้ามนำทุเรียนหรืออาหารที่มีกลิ่นรุนแรงเข้าห้องพักโดยเด็ดขาด",
        "หากต้องการเลื่อนวันเข้าพัก กรุณาแจ้งล่วงหน้าอย่างน้อย 7 วัน และเลื่อนได้เพียง 1 ครั้งเท่านั้น",
        "ที่พักไม่สามารถยกเลิกได้ทุกกรณี",
        "ค่าบริการผู้เข้าพักเพิ่ม: เด็กอายุไม่เกิน 10 ปี ไม่มีค่าใช้จ่าย หากเกินคิดเพิ่ม 750 บาท/ท่าน/คืน",
      ],
    },
  },
  ...
  /* ────────────────────────────────────────
     ...
     ──────────────────────────────────────── */
  seo: {
    siteUrl: "https://landcampkhaoyai.com",
    defaultLocale: "th_TH",
