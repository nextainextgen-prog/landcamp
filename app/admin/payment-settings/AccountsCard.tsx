      ...
      <Card.Content>
        <div className="mb-4 flex items-start gap-3 rounded-md border border-emerald-200 bg-emerald-50 p-3 text-sm text-emerald-900">
          ...
          <div className="flex flex-col gap-1">
            <span>
              <strong>ตั้งค่าบัญชีรับเงิน EasySlip</strong> — ตั้งบัญชีรับเงินที่นี่ที่เดียว บัญชีในหน้านี้ใช้ทั้ง <strong>แสดงให้ลูกค้าโอนเข้า</strong> และ
              <strong> ตรวจสลิปอัตโนมัติ</strong> (เทียบบัญชีปลายทางบนสลิปกับบัญชีที่เปิดใช้งานไว้ที่นี่)
            </span>
          </div>
        </div>
        {rows.length === 0 ? (
